...
@section('content')
        ...
        <div class="flex flex-col mt-20 gap-[50px]">
            ...
            <div class="flex flex-col gap-5">
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="font-semibold text-cp-dark-blue">Jl. Raya Kranggan Kavling Palm Residence No.4, RT.003/RW.008, Jatiraden, Kec. Jatisampurna, Kota Bks, Jawa Barat 17432</p>
                </div>
                <div class="flex items-center gap-[10px]">
                    <div class="flex w-6 h-6 shrink-0">
                        <img src="assets/icons/call.svg" alt="icon">
                    </div>
                    <p class="font-semibold text-cp-dark-blue">0818-0822-5354</p>
                </div>
                <div class="flex items-center gap-[10px]">
                    <div class="flex w-6 h-6 shrink-0">
                        <img src="assets/icons/monitor-mobbile.svg" alt="icon">
                    </div>
                    <p class="font-semibold text-cp-dark-blue">vivacelebrity.com</p>
                </div>
            </div>
        </div>
    ...
    <footer class="relative w-full mt-20 overflow-hidden bg-cp-black">
        ...
        <div class="absolute -bottom-[135px] w-full">
            <p class="font-extrabold text-[250px] leading-[375px] text-center text-white opacity-5">syhbdna</p>
        </div>
    </footer>
@endsection
